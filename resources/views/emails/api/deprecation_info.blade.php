...
<head>
    ...
    <style>
        ...
        .alert { background: #d1ecf1; border: 1px solid #bee5eb; padding: 15px; margin: 15px 0; border-radius: 5px; }
        ...
        .info { background: #17a2b8; color: white; padding: 15px; margin: 15px 0; border-radius: 5px; text-align: center; font-weight: bold; }
    </style>
</head>
<body>
    <div class="container">
        <div class="header">
            <h1>ℹ️ API Version Deprecation Notice</h1>
            <p>Information Only</p>
        </div>
        
        <div class="content">
            <div class="info">
                ℹ️ API Version {{ $version }} will be sunset in {{ $days_remaining }} days
            </div>
            
            <p>Dear {{ $user_name }},</p>
            
            <p>This is an informational notice that API version <strong>{{ $version }}</strong> will be permanently discontinued on <strong>{{ $sunset_date }}</strong>.</p>
            
            <p>You have <strong>{{ $days_remaining }} days</strong> to plan your migration to the newer API version.</p>
            
            <div class="alert">
                <strong>What this means:</strong>
                <ul>
                    <li>All API calls to version {{ $version }} will stop working</li>
                    <li>Your applications will need updates</li>
                    <li>Plan your migration timeline</li>
                </ul>
            </div>
            
            <h3>Recommended Timeline:</h3>
            <ul>
                <li><strong>Now:</strong> Review migration requirements</li>
                <li><strong>{{ $days_remaining - 60 }} days:</strong> Start development</li>
            ...
            <p><strong>This is an informational notice. No immediate action is required, but please plan your migration.</strong></p>
        </div>
