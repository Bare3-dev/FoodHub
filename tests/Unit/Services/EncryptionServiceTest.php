...
class EncryptionServiceTest extends TestCase
{
    ...
    public function it_masks_sensitive_data()
    {
        ...
        $masked = $this->encryptionService->maskSensitiveDataString($sensitiveData);
        
        $this->assertNotEquals($sensitiveData, $masked);
        $this->assertStringContainsString('*', $masked);
        $this->assertEquals(strlen($sensitiveData), strlen($masked));
    }
