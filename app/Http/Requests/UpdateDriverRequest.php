...
class UpdateDriverRequest extends FormRequest
{
    ...
    {
        // Get the driver ID from the route parameters for unique validation.
        ...
        return [
            ...
            'driver_license_number' => 'string|max:255|unique:drivers,driver_license_number,' . $driverId,
            ...
            'vehicle_plate_number' => 'string|max:255|unique:drivers,vehicle_plate_number,' . $driverId,
            'vehicle_image_url' => 'nullable|string|max:255',
            'status' => 'string|in:pending_verification,active,inactive,suspended,blocked',
            'is_online' => 'boolean',
